  ...
  return (
    <div>
      <Link to={`/event/lesson/${props.slug}`} className="group">
        ...
        <div className={classnames(`relative rounded mt-2 p-4 border border-gray-500 group-hover:border-green-500`, {
          'bg-green-500': isLessonActive
        })}>
          <div className={classnames(``, {
            'bg-green-500 rotate-45 w-4 h-4 absolute left-[-0.50rem]': isLessonActive
          })}></div>
