...
export function Sidebar() {
  ...
  return (
    <aside className={`${isOpen ? `fixed z-20 right-0 md:static `
      ...
      transition-all bg-gray-700 p-6 border-l flex-col w-screen md:w-[21.75rem]  md:block md:right-0 max-h-screen md:max-h-full border-gray-600 overflow-y-scroll md:overflow-auto`}>
