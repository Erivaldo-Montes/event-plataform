...
export type CreateSubscribesMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreateSubscribesMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };

export type GetLessonBylugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessonBylugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', videoId: string, title: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
...
export const CreateSubscribesDocument = gql`
  ...
  createSubscriber(data: {name: $name, email: $email}) {
    ...
    `;
export type CreateSubscribesMutationFn = Apollo.MutationFunction<CreateSubscribesMutation, CreateSubscribesMutationVariables>;

/**
 * __useCreateSubscribesMutation__
 *
 * To run a mutation, you first call `useCreateSubscribesMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSubscribesMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSubscribesMutation, { data, loading, error }] = useCreateSubscribesMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSubscribesMutation(baseOptions?: Apollo.MutationHookOptions<CreateSubscribesMutation, CreateSubscribesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSubscribesMutation, CreateSubscribesMutationVariables>(CreateSubscribesDocument, options);
      }
export type CreateSubscribesMutationHookResult = ReturnType<typeof useCreateSubscribesMutation>;
export type CreateSubscribesMutationResult = Apollo.MutationResult<CreateSubscribesMutation>;
export type CreateSubscribesMutationOptions = Apollo.BaseMutationOptions<CreateSubscribesMutation, CreateSubscribesMutationVariables>;
export const GetLessonBylugDocument = gql`
    query GetLessonBylug($slug: String) {
...
/**
 * __useGetLessonBylugQuery__
 *
 * To run a query within a React component, call `useGetLessonBylugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonBylugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonBylugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessonBylugQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonBylugQuery, GetLessonBylugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonBylugQuery, GetLessonBylugQueryVariables>(GetLessonBylugDocument, options);
      }
export function useGetLessonBylugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonBylugQuery, GetLessonBylugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonBylugQuery, GetLessonBylugQueryVariables>(GetLessonBylugDocument, options);
        }
export type GetLessonBylugQueryHookResult = ReturnType<typeof useGetLessonBylugQuery>;
export type GetLessonBylugLazyQueryHookResult = ReturnType<typeof useGetLessonBylugLazyQuery>;
export type GetLessonBylugQueryResult = Apollo.QueryResult<GetLessonBylugQuery, GetLessonBylugQueryVariables>;
